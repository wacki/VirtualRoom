...
EXTERN_C const IID IID_IColorFrame;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE AccessRawUnderlyingBuffer( 
            ...
            _Outptr_result_bytebuffer_(*capacity)  BYTE **buffer) = 0;
    ...
    typedef struct IColorFrameVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *AccessRawUnderlyingBuffer )( 
            ...
            _Out_  UINT *capacity,
            /* [annotation][size_is][size_is][out] */ 
            _Outptr_result_bytebuffer_(*capacity)  BYTE **buffer);
...
EXTERN_C const IID IID_IDepthFrame;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE AccessUnderlyingBuffer( 
            ...
            _Out_  UINT *capacity,
            /* [annotation][size_is][size_is][out] */ 
            _Outptr_result_bytebuffer_(*capacity)  UINT16 **buffer) = 0;
    ...
    typedef struct IDepthFrameVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *AccessUnderlyingBuffer )( 
            ...
            _Out_  UINT *capacity,
            /* [annotation][size_is][size_is][out] */ 
            _Outptr_result_bytebuffer_(*capacity)  UINT16 **buffer);
...
EXTERN_C const IID IID_IAudioSource;
    ...
    public:
        ...
        virtual /* [propget] */ HRESULT STDMETHODCALLTYPE get_AudioEncodingProperties( 
            /* [annotation][out][retval] */ 
            _Outptr_  WAVEFORMATEX **audioEncodingProperties) = 0;
    ...
    typedef struct IAudioSourceVtbl
    {
        ...
        /* [propget] */ HRESULT ( STDMETHODCALLTYPE *get_AudioEncodingProperties )( 
            IAudioSource * This,
            /* [annotation][out][retval] */ 
            _Outptr_  WAVEFORMATEX **audioEncodingProperties);
...
#define IAudioSource_get_AudioEncodingProperties(This,audioEncodingProperties)	\
    ( (This)->lpVtbl -> get_AudioEncodingProperties(This,audioEncodingProperties) ) 
...
EXTERN_C const IID IID_ICoordinateMapper;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetDepthFrameToCameraSpaceTable( 
            ...
            _Outptr_result_bytebuffer_(*tableEntryCount)  PointF **tableEntries) = 0;
